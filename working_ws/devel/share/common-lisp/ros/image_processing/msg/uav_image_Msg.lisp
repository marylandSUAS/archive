...
(cl:defmethod cl:initialize-instance :after ((m <uav_image_Msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'uav_image_Msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name image_processing-msg:<uav_image_Msg> is deprecated: use image_processing-msg:uav_image_Msg instead.")))

(cl:ensure-generic-function 'image-val :lambda-list '(m))
(cl:defmethod image-val ((m <uav_image_Msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader image_processing-msg:image-val is deprecated.  Use image_processing-msg:image instead.")
  (image m))

(cl:ensure-generic-function 'pos-val :lambda-list '(m))
(cl:defmethod pos-val ((m <uav_image_Msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader image_processing-msg:pos-val is deprecated.  Use image_processing-msg:pos instead.")
  (pos m))

(cl:ensure-generic-function 'hdg-val :lambda-list '(m))
(cl:defmethod hdg-val ((m <uav_image_Msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader image_processing-msg:hdg-val is deprecated.  Use image_processing-msg:hdg instead.")
  (hdg m))

(cl:ensure-generic-function 'type-val :lambda-list '(m))
(cl:defmethod type-val ((m <uav_image_Msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader image_processing-msg:type-val is deprecated.  Use image_processing-msg:type instead.")
  (type m))

(cl:ensure-generic-function 'shape-val :lambda-list '(m))
(cl:defmethod shape-val ((m <uav_image_Msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader image_processing-msg:shape-val is deprecated.  Use image_processing-msg:shape instead.")
  (shape m))

(cl:ensure-generic-function 'background_color-val :lambda-list '(m))
(cl:defmethod background_color-val ((m <uav_image_Msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader image_processing-msg:background_color-val is deprecated.  Use image_processing-msg:background_color instead.")
  (background_color m))

(cl:ensure-generic-function 'alpha-val :lambda-list '(m))
(cl:defmethod alpha-val ((m <uav_image_Msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader image_processing-msg:alpha-val is deprecated.  Use image_processing-msg:alpha instead.")
  (alpha m))

(cl:ensure-generic-function 'alpha_color-val :lambda-list '(m))
(cl:defmethod alpha_color-val ((m <uav_image_Msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader image_processing-msg:alpha_color-val is deprecated.  Use image_processing-msg:alpha_color instead.")
  (alpha_color m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<uav_image_Msg>)))
  ...
  "image_processing/uav_image_Msg")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'uav_image_Msg)))
  "Returns string type for a message object of type 'uav_image_Msg"
  "image_processing/uav_image_Msg")
